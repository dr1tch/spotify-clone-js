import { HomeIcon, SearchIcon, LibraryIcon, PlusIcon, StatusOnlineIcon } from '@heroicons/react/outline';
        ...
        <div className='text-gray-500 p-5 border-r border-gray-900 overflow-y-scroll h-screen scrollbar-hide'>
            <div>
                ...
                <div className=' flex flex-col gap-10 font-semibold text-sm'>
                    ...
                    <div className='flex flex-col items-start justify-center gap-4 font-bold'>
                        <button className='flex items-center gap-5 hover:text-white'>
                            <div className='h-6 w-6 rounded-sm bg-gray-400 flex justify-center items-center'>
                                <PlusIcon className='w-4 h-4 text-gray-900' />
                            </div>
                            <p>Create Playlist</p>
                        </button>
                        <button className='flex items-center gap-5 hover:text-white'>
                            <div className='h-6 w-6 rounded-sm bg-gradient-to-tl from-purple-300 to-purple-700 flex justify-center items-center'>
                                <HeartIcon className='w-4 h-4 text-gray-300' />
                            </div>
                            <p>Liked Songs</p>
                        </button>
                        <button className='flex items-center gap-5 hover:text-white'>
                            <div className='h-6 w-6 rounded-sm bg-green-800 flex justify-center items-center'>
                                <StatusOnlineIcon className='w-4 h-4 text-green-500' />
                            </div>
                            <p>Your Episodes</p>
                        </button>
                    </div>
